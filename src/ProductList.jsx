                        ...
                        <div key={index}> {/* Unique key for each category div */}
                            ...
                            {category.plants.map((plant, plantIndex) => ( // Loop through each plant in the current category
                                ...
                                <button
                                    ...
                                    onClick={() => handleAddToCart(plant)} disabled = {addedToCart[plant.name]} style={{ backgroundColor: addedToCart[plant.name] ? 'gray' : '#4CAF50', color: 'white', padding: '10px 20px', border: 'none', borderRadius: '5px', cursor: addedToCart[plant.name] ? 'not-allowed' : 'pointer' }} 
                                >
